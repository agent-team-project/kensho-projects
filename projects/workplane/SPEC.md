...
**Status:** M1 walking slice plus M2A durable delivery/replay, M2B resumable realtime, and M2C planning-contract spines implemented; remaining durable-core and release scope remains specified
**Version:** 0.1
