...
**Status:** M1 walking slice plus M2A durable delivery/replay and M2B resumable realtime spines implemented; remaining durable-core and release scope remains specified
**Version:** 0.1
