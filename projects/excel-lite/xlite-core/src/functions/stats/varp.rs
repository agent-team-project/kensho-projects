...
impl Function for VarP {
    ...
    fn call(&self, args: &[Arg<'_>], ctx: &FnContext<'_>) -> Value {
        ...
        Value::Number(sum_squared_deviations / count)
    }
}

static VARP: VarP = VarP;
inventory::submit! { FunctionEntry(&VARP) }
...
mod tests {
    ...
    fn reports_excel_arity_limit() {
        assert_eq!(VARP.arity(), (1, Some(255)));
    }
    ...
    fn rejects_wrong_direct_arity() {
        ...
        assert_eq!(VARP.call(&args, &fn_ctx), Value::Error(ErrorValue::Value));
    }

    #[test]
    fn calculates_population_variance_for_known_data() {
        assert_number_close(
            call_values(vec![
                Value::Number(1345.0),
                Value::Number(1301.0),
    ...
    fn aggregates_range_numbers_and_ignores_non_numbers() {
        ...
        assert_number_close(
            VARP.call(&[range_arg(&ctx, (0, 0), (2, 1))], &fn_ctx),
            8.0 / 3.0,
        );
    }

    #[test]
    fn returns_zero_for_single_numeric_value() {
    ...
    fn returns_div0_when_no_numbers_remain() {
        ...
        assert_eq!(
            VARP.call(&[range_arg(&ctx, (0, 0), (1, 1))], &fn_ctx),
    ...
    fn propagates_aggregation_errors() {
        ...
        assert_eq!(
            VARP.call(&[range_arg(&ctx, (0, 0), (0, 1))], &fn_ctx),
