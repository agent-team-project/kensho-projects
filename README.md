...
| [Workplane](projects/workplane/) | M1 plus M2A durable, M2B realtime, and M2C planning-contract spines implemented | Agent-native project and portfolio coordination with evidence, permissions, events, and empirical dogfooding | [Specification and verification gates](projects/workplane/README.md) |
...
- Workplane implements its serialized M1 walking slice and the M2A/M2B/M2C
  Track B transactional-outbox/replay/realtime/planning-contract units; broader
  M2 domain and release claims remain unimplemented.
